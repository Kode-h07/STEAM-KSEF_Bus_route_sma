...
max_station = filtered_df.loc[filtered_df["normalized_passenger_count"].idxmax(), "정류소명"]

# Find the station with the minimum normalized passenger count
min_station = filtered_df.loc[filtered_df["normalized_passenger_count"].idxmin(), "정류소명"]
...
print(filtered_df[["정류소명", "normalized_passenger_count", "pheromone"]])
